                    ...
                    if (selectedItem == null) {
                        ...
                        AnimatedVisibility(
                            ...
                            Column(Modifier.padding(16.dp)) {
                                Text("Пріоритет: ${selectedItem!!.priority}")
                                Text("Категорія: ${selectedItem!!.category}")
                                Text("Настрій: ${selectedItem!!.mood}")
                                Text("Обране: ${if (selectedItem!!.isFavorite) "Так" else "Ні"}")
                            }
                        }
                    }
                }
